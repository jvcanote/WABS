...
abstract class CMB_Field {
	...
	public function placeholder_attr( $attrs = array() ) {

		if ( $this->args['placeholder'] )
			printf( 'placeholder="%s"', esc_attr( $this->args['placeholder'] ) );

	}

	public function number_attr( $attrs = array() ) {

		if ( $this->args['maxlength'] )
			$attrs['maxlength'] = $this->args['maxlength'];
		...
		$attrs = array_filter( array_map( 'intval', array_unique( $attrs ) ) );
...
class CMB_Text_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input type="text" <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->number_attr(); ?> <?php $this->class_attr(); ?> <?php $this->name_attr(); ?> <?php $this->placeholder_attr(); ?> value="<?php echo esc_attr( $this->get_value() ); ?>" />
...
class CMB_Number_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input type="number" <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->number_attr(); ?> <?php $this->class_attr( 'cmb_text_number code' ); ?> <?php $this->name_attr(); ?> <?php $this->placeholder_attr(); ?> value="<?php echo esc_attr( $this->value ); ?>" />
...
class CMB_URL_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input type="text" <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->number_attr(); ?> <?php $this->class_attr( 'cmb_text_url code' ); ?> <?php $this->name_attr(); ?> <?php $this->placeholder_attr(); ?> value="<?php echo esc_attr( esc_url( $this->value ) ); ?>" />
...
class CMB_Textarea_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<textarea <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->number_attr(); ?> <?php $this->class_attr(); ?> <?php $this->placeholder_attr(); ?> rows="<?php echo ! empty( $this->args['rows'] ) ? esc_attr( $this->args['rows'] ) : 4; ?>" <?php $this->name_attr(); ?>><?php echo esc_textarea( $this->value ); ?></textarea>
